...
> **Las listas son las de la iglesia, no las del programa.** Los tipos de actividad y los motivos de ausencia los mantiene cada iglesia en su propia pantalla, y esta los pide de ahí: al agregar «Retiro espiritual» aparece en el filtro y en el diálogo sin tocar nada más. Antes los pedía de donde ya no estaban y recibía una lista vacía sin decirlo, así que el filtro no ofrecía ninguno de los doce tipos configurados, una actividad nueva quedaba siempre con el de fábrica, y **una actividad ya creada no se podía volver a guardar**: el diálogo mandaba el tipo en blanco. Lo mismo con los motivos: al justificar se ofrecían los escritos en el código, y marcar «Viaje» como que pide explicación no servía de nada.
