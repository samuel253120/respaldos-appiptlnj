...
module.exports = {
  ...
  listFields: ['cuerpo_id', 'periodo', 'presidente_id', 'fecha_inicio', 'fecha_termino', 'estado'],
  ...
  fields: [
    ...
    { name: 'vicepresidente_id', label: 'Vicepresidente(a)', type: 'ref', ref: 'miembros' },
    { name: 'secretario_id', label: 'Secretario(a)', type: 'ref', ref: 'miembros' },
    { name: 'tesorero_id', label: 'Tesorero(a)', type: 'ref', ref: 'miembros' },
    { name: 'otros_cargos', label: 'Otros cargos', type: 'textarea', help: 'Ej: Directora de música: Ana Soto' },
