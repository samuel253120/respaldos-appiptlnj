 ...
 */
const VERSIONES = [
  { version: "1.234.0", fecha: "2026-08-31", titulo: "La ficha de una iglesia dice por fin lo que el sistema sabe de ella. Mostraba cinco datos —nombre, tipo, código, ciudad, estado— y nueve campos en blanco, mientras el sistema sabía de esa misma congregación 600 miembros, 13 cuerpos, 1 pastor, 28 cuentas, 3.001 movimientos y 150 actividades, y no decía ninguna de esas cifras: para saber cuánta gente tiene había que ir a Miembros y filtrar, y para saber cuánto tiene en caja, a Cuentas de Tesorería y filtrar. Tenía cuatro pestañas contra las siete del cuerpo más chico de la organización, así que la ficha de la iglesia entera decía menos de sí misma que la de cualquiera de sus grupos. Ahora arriba de la ficha —fuera de las pestañas, porque es lo que se mira ANTES de decidir— va el resumen: cuánta gente, cuántos cuerpos, cuántos pastores, cuánto hay en sus propias cajas, cuántas actividades lleva este año y cuándo fue la última; cada cifra lleva de un clic a la lista que la explica. Y estrena cuatro pestañas: Miembros, Cuerpos, Pastores y Tesorería. La plata de sus cuerpos va aparte de la suya, con la misma regla que el inventario: son dos dueños distintos. Cada cifra pide su propio permiso y la que la persona no puede ver no viaja, porque un resumen entrega el dato sin que haya que abrir nada" },
  { version: "1.233.0", fecha: "2026-08-31", titulo: "Una iglesia creada por error ya se puede deshacer. Que una iglesia con gente adentro no se borre está bien y sigue igual; el problema era la otra, la que se creó hace un minuto con el nombre mal escrito: borrarla al segundo de crearla contestaba «cuelgan de ella 3 registros», y esos tres eran sus dos cuentas de tesorería —que el propio módulo le abre al crearla— y la línea de historial que la bitácora le anota. El sistema fabricaba los motivos por los que después se negaba, y cada vez que alguien la tocaba sumaba uno más. Ahora se distingue lo que la iglesia TIENE de lo que el sistema ESCRIBIÓ sobre ella: si lo único que cuelga es el rastro de haberla creado —cuentas recién abiertas y sin un peso, anotaciones automáticas de historial— el borrado pregunta, dice exactamente qué se va con ella, y deja seguir. Con un miembro, un peso, un acta o una nota escrita a mano se frena como siempre. El Registro de Cambios no se va nunca: conserva sus líneas, deja de apuntar a la iglesia borrada y anota el borrado. Y si lo único que cuelga son cuentas de usuario asignadas a ella, el aviso dice el otro motivo: soltarlas las dejaría sin ninguna iglesia asignada, que en este sistema significa alcanzarlas todas" },
  { version: "1.232.0", fecha: "2026-08-31", titulo: "«Inactiva» pasa a significar algo. El estado estaba en la ficha de cada iglesia, se guardaba y se pintaba de gris en el listado, y ninguna regla del sistema lo consultaba: sobre una congregación marcada como inactiva, anotarle un miembro daba 201, crearle un cuerpo 201 y meterle plata en la caja 201, y el desplegable de cualquier ficha la seguía ofreciendo igual que a las que funcionan. Y era la ÚNICA salida que el sistema ofrece para retirar una congregación, porque borrarla está prohibido y el aviso que lo dice termina con «márquela como inactiva»: quien cerraba una iglesia hacía lo que le decían y quedaba convencido de que el asunto estaba resuelto. Ahora una iglesia retirada no recibe nada nuevo —ni gente, ni cuerpos, ni plata, ni papeles, ni por la puerta de atrás de un módulo que deduce la iglesia en vez de recibirla— y los desplegables dejan de ofrecerla, salvo en la ficha de quien ya pertenece a ella, que la sigue mostrando para no borrársela al guardar. Lo que ya está adentro se sigue corrigiendo, consultando e imprimiendo; su historial y sus documentos se le siguen escribiendo, porque el cierre es justamente lo que hay que poder anotar; y su propia ficha se edita: es como se la vuelve a abrir" },
  { version: "1.231.0", fecha: "2026-08-31", titulo: "Al inventario de un cuerpo se llega desde su ficha: era lo único suyo que no se veía ahí —tenía integrantes, cuotas, tesorería, directivas y actas— y había que ir a buscarlo al listado general, que además no se dejaba filtrar por cuerpo. La iglesia también tiene la suya, y las dos traen el total de lo inventariado SEPARANDO lo propio de lo ajeno, que es lo que hace que la cifra sirva: un inventario que suma en un mismo total la batería que un hermano dejó en depósito y las bancas que la iglesia compró no dice ni cuánto tiene la iglesia ni cuánto está cuidando de otros. Y hay hoja del inventario de un nivel para imprimir, que es lo que se lleva a una revisión y lo que se firma al entregar un cargo" },
  { version: "1.230.0", fecha: "2026-08-31", titulo: "El inventario distingue por fin lo que es de la iglesia de lo que no: cada artículo tiene un «Régimen del bien» —propio, prestado a la iglesia, o en depósito bajo responsabilidad de su dueño—, con el dueño, cómo ubicarlo, desde cuándo está y hasta cuándo se prometió devolverlo. Antes no había dónde anotarlo: cinco artículos sembrados —dos de la iglesia, uno prestado y uno en depósito— se veían todos iguales en el listado, y buscar «prestado» daba cero resultados porque la nota decía «lo prestó». Ahora el régimen se ve sin abrir la ficha y se filtra por él; un depósito sin la firma del dueño pregunta antes de guardarse; el panel avisa de lo prestado que hay que devolver, con el plazo que fije Configuración; y desde la ficha se imprime la constancia de préstamo o de depósito para firmar en dos copias, con la cláusula de responsabilidad que la corporación escribe en Configuración" },
  { version: "1.229.0", fecha: "2026-08-31", titulo: "Un artículo de inventario ya puede ser de la CORPORACIÓN: el nivel se elige —corporación, iglesia local, cuerpo o grupo, las mismas tres opciones que una cuenta de tesorería— en vez de deducirse de si el campo del cuerpo venía vacío. Antes «Iglesia» era obligatorio y un bien de toda la organización había que colgárselo a alguna congregación, donde quedaba contado como suyo. Y la iglesia de un bien de cuerpo la pone el cuerpo: se podía anotar un artículo en una iglesia con el cuerpo de otra, y quedaba contado en dos partes a la vez. Lo que ya estaba anotado estrena al arrancar el nivel que tenía de hecho" },
  { version: "1.228.0", fecha: "2026-08-31", titulo: "Tres arreglos del listado y de la ficha de un traspaso: se pregunta antes de guardar uno fechado antes de que las cuentas existieran —un traspaso al 03-03-1998 entre dos cuentas abiertas en 2020 entraba callado y quedaba en un período ya cuadrado—; los títulos de las columnas se parten en dos líneas en vez de echar la tabla de la pantalla, que dejaba los botones de imprimir y eliminar fuera de la vista en quince listados; y en el título de una ficha una fecha se lee como fecha, no «2026-06-10» encima de un campo que dice «10-06-2026»" },
  { version: "1.227.0", fecha: "2026-08-31", titulo: "Un traspaso se alcanza por cualquiera de sus dos cuentas: la iglesia que RECIBE veía el ingreso en su cuenta y al abrir el traspaso que lo explica recibía un 403, quedándose sin el comprobante, el n.º de operación ni quién lo anotó, que es lo que necesita para cuadrar contra la cartola de su banco. Se admite el traspaso y nada más: ni la cuenta de la otra congregación, ni sus movimientos, ni los traspasos que no la tocan" },
  { version: "1.226.0", fecha: "2026-08-31", titulo: "Al elegir la cuenta de origen de un traspaso ya se ve cuánto hay en ella: el aviso estaba escrito —con su saldo, su cifra en rojo si está negativo, lo agendado y el candado para quien no alcanza los montos— y su hueco estaba siempre vacío, porque el buscador avisaba de «cambió» sobre la caja de texto y no sobre el campo. Cualquier campo de referencia avisa ahora donde corresponde" },
  { version: "1.225.0", fecha: "2026-08-31", titulo: "Una cuenta cerrada congela la plata de un traspaso, no su redacción: hasta ahora no se le podía corregir ni una falta de ortografía —«Diezmo de mazo» se quedaba así para siempre— mientras que borrarlo entero sí se podía. Ahora se congelan la fecha, el monto y las cuentas, y se siguen corrigiendo el concepto, el número de operación, la forma, el comprobante y las notas" },
  { version: "1.224.0", fecha: "2026-08-31", titulo: "Eliminar un traspaso que toca una cuenta cerrada pregunta antes: le sacaba $ 400.000 a una cuenta cerrada con un 200 y sin decir nada, mientras las otras tres puertas del sistema se negaban a mover un peso de esa misma cuenta. Ahora dice de qué lado y cuánto —si la plata le vuelve o le sale— y por qué importa; y se pregunta, no se prohíbe, porque un traspaso mal anotado hay que poder borrarlo" },
  { version: "1.223.0", fecha: "2026-08-31", titulo: "En un traspaso, la plata se entrega hacia arriba: la tesorera de una iglesia ya puede traspasarle a la corporación —el caso que el propio módulo se pone de ejemplo, que hasta ahora contestaba 403 después de ofrecer esa cuenta en el desplegable— y la de un cuerpo, entregarle a su iglesia. Nunca hacia el lado ni hacia abajo, y entregar no es administrar: la cuenta de arriba sigue sin poder abrirse ni ser el origen de nada. El desplegable ofrece ahora exactamente lo que el guardado acepta" },
  { version: "1.222.0", fecha: "2026-08-31", titulo: "Por la pantalla de Importar entraba lo que el formulario rechaza: una tesorera acotada a su iglesia metió $ 150.000 en la cuenta de otra congregación y otros $ 150.000 en la de la corporación, y una tesorera de cuerpo sin la llave del nivel general le sacó $ 90.000 a la caja de su iglesia. La planilla aplica ahora el mismo alcance que el formulario —las fichas que la fila nombra y el nivel de tesorería—, y le sirve a los 39 módulos" },
  { version: "1.221.0", fecha: "2026-08-30", titulo: "Poner de responsable de una cuenta a alguien de otra iglesia ahora pregunta antes: el campo apuntaba a la ficha de un miembro y no miraba de qué congregación era, así que una cuenta quedaba a nombre de quien probablemente ni siquiera puede verla. Se pregunta y no se bloquea, porque hay casos legítimos" },
  ...
  { version: "1.189.0", fecha: "2026-08-29", titulo: "El documento se adjunta en la misma ventana en que se anota, y la pestaña, el listado y la hoja impresa dicen cuáles anotaciones lo llevan" },
  { version: "1.188.0", fecha: "2026-08-29", titulo: "El bautismo queda anotado como bautismo y en su fecha, y la credencial de un pastor se anota en la bitácora del miembro que es" },
  { version: "1.187.0", fecha: "2026-08-29", titulo: "Una fecha dentro de una anotación se escribe como se lee acá, en los tres historiales y en el Registro de Cambios" },
